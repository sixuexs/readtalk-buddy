...
MySQL                                MongoDB
─────                                ───────
evaluation_record ──interaction_id──▶ interaction_meta ──biz_id──▶ conversation_detail
...
conversations (MongoDB)               user_profile (MongoDB)
    │ Evaluation: 5维评分                  │ avgClarity / avgLogicality / … / overallScore
    │ messages[]: 消息流                   │ ScoreRecord[]: 历次评分快照
    ▼ 对话主文档                          ▼ AI 能力画像
```
